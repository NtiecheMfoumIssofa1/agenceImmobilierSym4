 ...
 */
final class Version20190321124833 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP surface, DROP rooms, DROP bedrooms, DROP floor, DROP price, DROP heat, DROP city, DROP address, DROP postal_code, DROP sold, DROP created_at');
    }
}
